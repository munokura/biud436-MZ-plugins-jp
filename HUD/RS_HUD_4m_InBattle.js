 ...
 * @target MZ
 * @base RS_HUD_4m
 * @plugindesc (v2.0.1) 戦闘画面にHUDを表示できます。 <RS_HUD_4m_InBattle>
 * @author biud436
 * @url https://raw.githubusercontent.com/munokura/biud436-MZ-plugins-jp/master/HUD/RS_HUD_4m_InBattle.js
 *
 * @param >>> Image Name
 * @text >>>画像名
 *
 ...
 * @parent >>> Noraml
 * @type boolean
 * @desc ログウィンドウとヘルプウィンドウを除くすべてのウィンドウの座標を整流化します。
 * @default true
 *
 * @param >>> Text Settings
 * @text >>>>文字設定
 ...
 * @type string[]
 * @desc 各HUDの基準位置となる配列を指定
 * @default ["Pos 1", "Pos 2", "Pos 3", "Pos 4"]
 *
 * @param Pos 1
 * @text 位置1
 * @parent >>> Custom HUD Anchor
 * @desc HUDスプライト作成時の座標を指定
 * @default [0, BH - (H * 2) - PD]
 *
 * @param Pos 2
 * @text 位置2
 ...
 * 
 * 元プラグイン
 * https://raw.githubusercontent.com/biud436/MZ/master/HUD/RS_HUD_4m_InBattle.js
 * 
 * 戦闘画面にHUDを表示します。
 * 
 * このプラグインには RS_HUD_4m が必要です。
 * このプラグインをプラグイン管理リストで RS_HUD_4m の下側に配置してください。
 */
